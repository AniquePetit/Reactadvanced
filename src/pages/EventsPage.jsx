...
const EventsPage = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://tidal-vagabond-squid.glitch.me/api/categories')  // Aangepast naar Glitch URL
    ...
    fetch('https://tidal-vagabond-squid.glitch.me/api/events')  // Aangepast naar Glitch URL
